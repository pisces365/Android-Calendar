...
public class CalendarLayout extends LinearLayout {
     ...
     * 日历
     */
    edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarView mCalendarView;
...
//    private static final int GESTURE_MODE_ONLY_CALENDAR = 1;
     ...
     * @param cur 当前日期时间
     */
    private void initCalendarPosition(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar cur) {
        int diff = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getMonthViewStartDiff(cur, mDelegate.getWeekStart());
    ...
    void updateContentViewTranslateY() {
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar = mDelegate.mIndexCalendar;
        if (mDelegate.getMonthViewShowMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.MODE_ALL_MONTH) {
            mContentViewTranslateY = 5 * mItemHeight;
        } else {
            mContentViewTranslateY = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getMonthViewHeight(calendar.getYear(),
    ...
    final void updateCalendarItemHeight() {
        ...
        if (mContentView == null)
            return;
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar = mDelegate.mIndexCalendar;
        updateSelectWeek(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getWeekFromDayInMonth(calendar, mDelegate.getWeekStart()));
        if (mDelegate.getMonthViewShowMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.MODE_ALL_MONTH) {
            mContentViewTranslateY = 5 * mItemHeight;
        } else {
            mContentViewTranslateY = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getMonthViewHeight(calendar.getYear(), calendar.getMonth(),
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dy > 0 && mContentView.getTranslationY() == 0 && y >= edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.dipToPx(getContext(), 98)) {
                    return false;
                }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int weekBarHeight = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.dipToPx(getContext(), 1)
                + mDelegate.getWeekBarHeight();

        int monthHeight = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getMonthViewHeight(year, month,
    ...
    protected void onFinishInflate() {
        ...
        if (getChildCount() > 0) {
            mCalendarView = (edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarView) getChildAt(0);
        }
